...
import InstagrammImg from './InstagrammImg';
...
const Instagram = () => {
  return (
    ...
    <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 p-4'>
        <InstagrammImg socialImg={IgImg1} />
        <InstagrammImg socialImg={IgImg2} />
        <InstagrammImg socialImg={IgImg3} />
        <InstagrammImg socialImg={IgImg4} />
        <InstagrammImg socialImg={IgImg5} />
        <InstagrammImg socialImg={IgImg6} />
    </div>
</div>
  )
}
